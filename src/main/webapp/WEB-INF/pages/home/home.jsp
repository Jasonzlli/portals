...
<script type="text/javascript">
    ...
    <div class="bg">
        <div class="main container">
        		<div class="banner">
        			<ul>
        				<li style="background-image:url(${ctx}/static/images/shows/show01.jpg);background-size:100% 100%;height:292px;"></li>
        				<li style="background-image:url(${ctx}/static/images/shows/show02.jpg);background-size:100% 100%;height:292px;"></li>
        			</ul>
        		</div>
            <div class="intro row">
                <div class="col-md-4">
                    ...
                    <a href="/home/home" target="_blank">+More</a></div>
                </div>
                <div class="col-md-5">
                    <div class="bs-callout bs-callout-danger">
                    	<h5>热门招聘</h5>
